...
enum DW_MACRO_GNU_define = .DW_MACRO_define;
enum DW_MACRO_GNU_undef = .DW_MACRO_undef;
enum DW_MACRO_GNU_start_file = .DW_MACRO_start_file;
enum DW_MACRO_GNU_end_file = .DW_MACRO_end_file;
enum DW_MACRO_GNU_define_indirect = .DW_MACRO_define_strp;
enum DW_MACRO_GNU_undef_indirect = .DW_MACRO_undef_strp;
enum DW_MACRO_GNU_transparent_include = .DW_MACRO_import;
enum DW_MACRO_GNU_lo_user = .DW_MACRO_lo_user;
enum DW_MACRO_GNU_hi_user = .DW_MACRO_hi_user;
...
enum
{
    ...
    DW_CIE_ID_64 = 0xffffffffffffffffUL /* In 64-bit format CIE header.  */
}
...
enum DWARF3_LENGTH_MIN_ESCAPE_CODE = 0xfffffff0u;
enum DWARF3_LENGTH_MAX_ESCAPE_CODE = 0xffffffffu;
enum DWARF3_LENGTH_64_BIT = DWARF3_LENGTH_MAX_ESCAPE_CODE;
